...
const (
	// Label holds the string label denoting the resumeskill type in the database.
	Label = "resume_skill"
	...
	EdgeResume = "resume"
	// Table holds the table name of the resumeskill in the database.
	Table = "resume_skills"
...
// Columns holds all SQL columns for resumeskill fields.
var Columns = []string{
	FieldID,
	FieldDeletedAt,
	FieldResumeID,
...
// OrderOption defines the ordering options for the ResumeSkill queries.
