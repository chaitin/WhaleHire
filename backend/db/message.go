...
func (*Message) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case message.FieldRole, message.FieldAgentName, message.FieldType, message.FieldContent, message.FieldMediaURL:
			values[i] = new(sql.NullString)
		case message.FieldDeletedAt, message.FieldCreatedAt, message.FieldUpdatedAt:
...
func (m *Message) QueryAttachments() *AttachmentQuery {
...
func (m *Message) Unwrap() *Message {
	...
	if !ok {
		panic("db: Message is not a transactional entity")
	}
