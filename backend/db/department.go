...
type DepartmentEdges struct {
	...
	Positions []*JobPosition `json:"positions,omitempty"`
...
func (e DepartmentEdges) PositionsOrErr() ([]*JobPosition, error) {
	if e.loadedTypes[0] {
...
func (d *Department) QueryPositions() *JobPositionQuery {
...
func (d *Department) Unwrap() *Department {
	...
	if !ok {
		panic("db: Department is not a transactional entity")
	}
