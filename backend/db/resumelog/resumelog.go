...
const (
	// Label holds the string label denoting the resumelog type in the database.
	Label = "resume_log"
	...
	EdgeResume = "resume"
	// Table holds the table name of the resumelog in the database.
	Table = "resume_logs"
	// ResumeTable is the table that holds the resume relation/edge.
	ResumeTable = "resume_logs"
...
// Columns holds all SQL columns for resumelog fields.
var Columns = []string{
	FieldID,
	FieldDeletedAt,
	FieldResumeID,
...
// OrderOption defines the ordering options for the ResumeLog queries.
