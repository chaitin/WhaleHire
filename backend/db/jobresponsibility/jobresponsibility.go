...
const (
	// Label holds the string label denoting the jobresponsibility type in the database.
	Label = "job_responsibility"
	...
	EdgeJob = "job"
	// Table holds the table name of the jobresponsibility in the database.
	Table = "job_responsibility"
	// JobTable is the table that holds the job relation/edge.
	JobTable = "job_responsibility"
...
// Columns holds all SQL columns for jobresponsibility fields.
var Columns = []string{
	FieldID,
	FieldDeletedAt,
	FieldJobID,
...
// OrderOption defines the ordering options for the JobResponsibility queries.
