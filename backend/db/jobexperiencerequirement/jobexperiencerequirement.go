...
const (
	// Label holds the string label denoting the jobexperiencerequirement type in the database.
	...
	JobTable = "job_experience_requirement"
...
var (
	...
	MinYearsValidator func(int) error
	// DefaultIdealYears holds the default value on creation for the "ideal_years" field.
...
// OrderOption defines the ordering options for the JobExperienceRequirement queries.
