...
## 院校类型标签说明
候选人教育经历中的 "university_types" 字段提供院校类型标签，可包含多个值：
- "ordinary": 普通高校
- "211": 211高校
- "985": 985高校
- "double_first_class": 双一流建设高校
- "qs_top100": QS世界大学排名前100

当存在多个标签时，按照上述优先级综合评估学校声誉。

## GPA 绩点评估
- GPA ≥ 3.7 或百分制 ≥ 90：优秀（可视作显著加分）
- GPA 3.3 - 3.69 或百分制 85-89：良好
- GPA 2.7 - 3.29 或百分制 75-84：一般
- GPA < 2.7 或百分制 < 75：需关注
- 未提供 GPA：记录为待补充信息
...
- resume_educations: 候选人教育经历列表，包括学校、专业、学历、毕业时间、院校类型标签（"university_types"）、绩点（"gpa"）等
...
4. **教育质量**：综合评估教育背景对职位胜任能力的支撑程度，特别关注院校类型标签与绩点评价
5. **信息缺口**：明确未提供的院校标签或GPA信息，并在分析中提出
