CREATE TABLE "admins"  (
    ...
    "updated_at" timestamptz NOT NULL, PRIMARY KEY  (
    "id"
)
);

CREATE UNIQUE INDEX "admins_username_key" ON "admins"  (
    "username"
);
...
CREATE TABLE "admin_login_histories"  (
    ...
    "created_at" timestamptz NOT NULL,
    "admin_id" uuid NULL, PRIMARY KEY  (
    "id"
), CONSTRAINT "admin_login_histories_admins_login_histories" FOREIGN KEY  (
    "admin_id"
) REFERENCES "admins"  (
    "id"
) ON DELETE SET NULL
...
CREATE TABLE "admin_roles"  (
    ...
    "id"
), CONSTRAINT "admin_roles_admins_admin" FOREIGN KEY  (
    "admin_id"
) REFERENCES "admins"  (
    "id"
) ON DELETE NO ACTION, CONSTRAINT "admin_roles_roles_role" FOREIGN KEY  (
    "role_id"
) REFERENCES "roles"  (
    "id"
) ON DELETE NO ACTION
...
CREATE UNIQUE INDEX "adminrole_role_id_admin_id" ON "admin_roles"  (
    "role_id",
    "admin_id"
);
...
CREATE TABLE "user_identities"  (
    ...
    "id"
), CONSTRAINT "user_identities_users_identities" FOREIGN KEY  (
    "user_id"
) REFERENCES "users"  (
    "id"
) ON DELETE SET NULL
...
CREATE TABLE "user_login_histories"  (
    ...
    "user_id" uuid NULL, PRIMARY KEY  (
    "id"
), CONSTRAINT "user_login_histories_users_login_histories" FOREIGN KEY  (
    "user_id"
) REFERENCES "users"  (
    "id"
) ON DELETE SET NULL
