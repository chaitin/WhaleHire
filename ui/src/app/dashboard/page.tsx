...
import { Search, Send, Plus, MessageCircle, FileText, Users, Briefcase, Settings, Mic, ArrowUpRight, ChevronLeft, ChevronRight } from 'lucide-react'
          ...
          <div className="space-y-1">
            ...
            <div className="p-4 border-t border-gray-700">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-200">User Profile</p>
                </div>
