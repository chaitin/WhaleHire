        ...
        <div className="relative z-10 flex flex-col justify-center h-full px-16">
          <div className="max-w-lg space-y-6">
            ...
            <h2 className="text-3xl font-semibold text-gray-900 text-left">
              智能招聘
              <span className="text-green-500 ml-3">AI驱动未来</span>
            </h2>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-8 shadow-xl border border-white/20">
                <div className="w-full h-64 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-lg relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 opacity-10">
                    ...
                    <div className="absolute top-8 right-8 w-6 h-6 bg-green-400 rounded-full"></div>
                  ...
                  <div className="relative z-10 flex items-center justify-center h-full">
                    <div className="text-center space-y-4">
                      ...
                      <div className="space-y-2">
                        <h3 className="text-gray-800 font-bold text-lg">AI智能筛选</h3>
                        <p className="text-gray-600 text-sm">精准匹配 • 高效招聘 • 智能推荐</p>
                      </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition-colors"
                    placeholder="请输入密码"
                  />
                  <button
                    type="button"
              ...
              <button
                ...
                disabled={isLoading}
                className={cn(
                  "w-full font-medium py-3 px-4 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2",
                  isLoading 
              ...
              <div className="text-center">
                <p className="text-gray-600">
                  ...
                  <Link
                    to="/register"
                    className="text-green-500 font-medium hover:text-green-600 ml-1"
                  >
                    立即注册
                  </Link>
                </p>
